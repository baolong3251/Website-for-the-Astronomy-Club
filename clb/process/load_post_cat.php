<?php 
	...
	$select_post = "SELECT * FROM post where post_type = '$cat_id' AND post_stat != 1 ORDER BY post_date DESC";
		...
		if ($post_type != 2 && $post_type!= 3) {
			...
			if($vote_value == 1){
				...
				<div class='loader-display'>
						...
						<p><a href='javascript:void(0)' style='color: orange;' class='likecat' id='$post_id'>Thích: $post_like</a></p>
						<p><a href='javascript:void(0)' class='dislikecat' id='$post_id'>Không thích: $post_dislike</a></p>
						</div>
			...
			if ($vote_value == -1) {
				...
				<div class='loader-display'>
						...
						<p><a href=''>Bình luận: $numComments</a></p>
						<div id='show_like_dislike_$post_id' class='edit-ld'>
						<p><a href='javascript:void(0)' class='likecat' id='$post_id'>Thích: $post_like</a></p>
						<p><a href='javascript:void(0)' style='color: blue;' class='dislikecat' id='$post_id'>Không thích: $post_dislike</a></p>
						</div>
						<p><a href=''>Lượt xem: $post_view</a></p>
						</div>
					</div>
